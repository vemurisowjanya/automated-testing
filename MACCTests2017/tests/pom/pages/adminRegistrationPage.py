...
class AdminRegistrationPage(BasePage):
    ...
    def fill_registration_form(self, info):
        ...
        self.send_value_to_element_id(elements.PHONE, info[6])
        self.submit_form()
    ...
    def register_valid_details(self):
        ...
        entry = ['admin-username','admin-password!@#$%^&*()_','admin-first-name','admin-last-name','admin-email@systers.org','admin-address','9999999999']
